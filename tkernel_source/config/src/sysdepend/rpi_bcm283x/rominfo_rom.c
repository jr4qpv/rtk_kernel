 ...
 *----------------------------------------------------------------------
 *
 *    Modified by T.Yokobayashi since 2016/07/19.
 *
 *----------------------------------------------------------------------
 */

/*
 *	@(#)rominfo_rom.c (rpi_bcm283x) 2019/05/02
 *
...
#define RI_USERINIT	(FP)0x00080000	/* User initialization program */
...
#|* 2016/08/18	Changed Kernel start address to 0x00030000.
#|* 2019/05/02	Changed USERINIT address to 0x00080000.
#|
*/
