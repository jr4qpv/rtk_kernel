...
*                                     - Evade collision of the function name
...
#include "../inc/serial_flash.h"
#include "../inc/serial_flash_spibsc.h"
#include "../inc/serial_flash_iobitmask.h"
...
/*******************************************************************************
 End of function sflash_spibsc_bsz_set
*******************************************************************************/

/******************************************************************************
* Function Name: sflash_spibsc_common_init
...
*              : -1 : error
******************************************************************************/
int32_t sflash_spibsc_common_init(uint32_t data_width, uint32_t spbr, uint32_t brdv)
{
...
/*******************************************************************************
 End of function sflash_spibsc_common_init
*******************************************************************************/

/******************************************************************************
* Function Name: sflash_spibsc_wait_tend
* Description  : Wait TEND
* Arguments    : void
* Return Value : none
******************************************************************************/
void sflash_spibsc_wait_tend(void)
{
...
/*******************************************************************************
 End of function sflash_spibsc_wait_tend
*******************************************************************************/

/******************************************************************************
* Function Name: sflash_spibsc_dr_init
...
*              : -1 : error
******************************************************************************/
int32_t sflash_spibsc_dr_init(st_spibsc_cfg_t *spibsccfg)
{
    int32_t ret = -1;
...
/*******************************************************************************
 End of function sflash_spibsc_dr_init
*******************************************************************************/

/*******************************************************************************
* Function Name: sflash_spibsc_exmode
* Description  :
* Arguments    : void
* Return Value :  0 :
*              : -1 : error
*******************************************************************************/
int32_t sflash_spibsc_exmode(void)
{
    int32_t ret = 0;
...
/*******************************************************************************
 End of function sflash_spibsc_exmode
*******************************************************************************/

/*******************************************************************************
* Function Name: sflash_spibsc_spimode
* Description  : Set to SPI mode.
* Arguments    : void
* Return Value :  0 :
*              : -1 : error
*******************************************************************************/
int32_t sflash_spibsc_spimode(void)
{
    int32_t ret = 0;
    volatile uint32_t dummy_read_32;
...
/*******************************************************************************
 End of function sflash_spibsc_spimode
*******************************************************************************/
...
/******************************************************************************
* Function Name: sflash_spibsc_transfer_single
...
*              : -1 : error
******************************************************************************/
int32_t sflash_spibsc_transfer_single(st_spibsc_spimd_reg_t *regset)
{
    int32_t ret;
...
/*******************************************************************************
 End of function sflash_spibsc_transfer_single
*******************************************************************************/

/******************************************************************************
* Function Name: sflash_spibsc_transfer_erase
* Description  : Transmission setting of a SPI multi-I/O bus controller.
...
*              : -1 : error
******************************************************************************/
int32_t sflash_spibsc_transfer_erase(uint32_t addr, uint32_t cmd, uint32_t addr_mode)
{
    uint32_t    temp_reg;
    uint32_t    smcr_reg;
...
/*******************************************************************************
 End of function sflash_spibsc_transfer_erase
*******************************************************************************/

/******************************************************************************
* Function Name: sflash_spibsc_transfer_program_1
* Description  : Transmission setting of a SPI multi-I/O bus controller.
* Arguments    : uint32_t addr
*              : uint32_t cmd
*              : uint32_t addr_mode
...
*              : -1 : error
******************************************************************************/
int32_t sflash_spibsc_transfer_program_1(uint32_t addr, uint32_t cmd, uint32_t addr_mode)
{
    uint32_t    temp_reg;
    uint32_t    smcr_reg;
...
/*******************************************************************************
 End of function sflash_spibsc_transfer_program_1
*******************************************************************************/

/******************************************************************************
* Function Name: sflash_spibsc_transfer_program_2
* Description  : Transmission setting of a SPI multi-I/O bus controller.
...
*              : -1 : error
******************************************************************************/
int32_t sflash_spibsc_transfer_program_2(uint32_t spide, uint32_t spidb, uint32_t *data, int32_t size)
{
    uint32_t    temp_reg;
    uint32_t    smcr_reg;
...
/*******************************************************************************
 End of function sflash_spibsc_transfer_program_2
*******************************************************************************/
...
/*----------------------------------------------------------------------
#|History of "serial_flash_ioset_drv.c"
#|-------------------------------------
