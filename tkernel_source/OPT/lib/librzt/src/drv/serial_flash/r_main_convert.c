...
*                                     - SPI_ADDR_MIRROR_AREA changed(bugfix)
...
void R_SPIBSC_Outaddr2SPI(void)
{
    ...
    mpu_init(SPI_REGION_RAW, SPI_ADDR_AREA, SPI_ADDR_XNBITON_MODE1, SPI_ADDR_AREA_SIZE);
    mpu_init(SPI_REGION_MIRROR, SPI_ADDR_MIRROR_AREA, SPI_ADDR_XNBITON_MODE2, SPI_ADDR_AREA_SIZE);
...
/*******************************************************************************
 End of function R_SPIBSC_Outaddr2SPI
*******************************************************************************/
...
void R_SPIBSC_SPI2Outaddr(void)
{
    ...
    /* region change 1 and 3 */
    mpu_init(SPI_REGION_RAW, SPI_ADDR_AREA, SPI_ADDR_XNBITOFF_MODE1, SPI_ADDR_AREA_SIZE);
    mpu_init(SPI_REGION_MIRROR, SPI_ADDR_MIRROR_AREA, SPI_ADDR_XNBITOFF_MODE2, SPI_ADDR_AREA_SIZE);
...
/*******************************************************************************
 End of function R_SPIBSC_SPI2Outaddr
*******************************************************************************/
...
/*******************************************************************************
 End of function level1_data_cache_cleaning
*******************************************************************************/
...
/*******************************************************************************
 End of function invalid_icache_and_flush_btac
*******************************************************************************/
