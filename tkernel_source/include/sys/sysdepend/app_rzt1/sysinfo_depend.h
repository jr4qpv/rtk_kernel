...
/*
 *	@(#)sysinfo_depend.h (sys/RZT1) 2018/08/23
 *
...
#define SCArea	( (SysCommonArea*)0x00800000 )
#define SCInfo	( SCArea->scinfo )

#endif /* _in_asm_source_ */

/* Definitions used by assembler */
#define TASKINDP	(0x00800800 + 4*4)	/* Task independent flag */
#define TASKMODE	(0x00800800 + 5*4)	/* Task mode flag */

/*
 * Vector table address
 */
#define EIT_VECTBL	0x00800000	/* Vector table top */
...
#|* 2018/08/23	SCAreaの先頭番地を0x0003C00～→0x00800000に変更。
#|
*/
